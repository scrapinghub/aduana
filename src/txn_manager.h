 ...
 *
 * Flags are the flags that you pass to LMDB's mdb_txn_begin. These flags
 * will be checked for MDB_RDONLY to decide which transaction counter to 
 * increment. This transaction will block if an environment resize is in progress.
 */
TxnManagerError
